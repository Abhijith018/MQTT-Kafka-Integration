...
public class KafkaBridge2 {

	//private static final Logger log = LoggerFactory.getLogger(KafkaBridge2.class);
	...
	//	log.info("Value22222222="+converted);
		...
		producerRecord = new ProducerRecord<>("topic_b", converted);
